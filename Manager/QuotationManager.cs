    ...
    public class QuotationManager
    {
        ...
        public Quotation Insertar(Quotation spe)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@estimatedtime", System.Data.SqlDbType.Int).Value = spe.EstimatedTime;
                cmd.Parameters.Add("@includesmaterials", System.Data.SqlDbType.Int).Value = spe.IncludesMaterial;
                cmd.Parameters.Add("@state", System.Data.SqlDbType.Int).Value = spe.State;
                cmd.Parameters.Add("@startdate", System.Data.SqlDbType.Int).Value = spe.StartDate;
                cmd.Parameters.Add("@finishdate", System.Data.SqlDbType.Int).Value = spe.FinishDate;
                cmd.Parameters.Add("@finalprice", System.Data.SqlDbType.Int).Value = spe.FinalPrice;
                cmd.Parameters.Add("@specialistrate", System.Data.SqlDbType.Int).Value = spe.SpecialistRate;
                cmd.Parameters.Add("@specialistcomment", System.Data.SqlDbType.Int).Value = spe.SpecialistComment;
                cmd.Parameters.Add("@customerrate", System.Data.SqlDbType.Int).Value = spe.CustomerRate;
                cmd.Parameters.Add("@customercomment", System.Data.SqlDbType.Int).Value = spe.CustomerComment;  
